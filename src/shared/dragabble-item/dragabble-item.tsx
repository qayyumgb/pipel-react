...
export function DraggableItem<T extends DraggableDefaultProps>(props: DraggableItemProps<T>): ReactElement {
    ...
    return (
        <>
            ...
            <DeleteItemModal isOpen={isDeleteModalOpen} closeModal={() => setIsDeleteModalOpen(false)}
