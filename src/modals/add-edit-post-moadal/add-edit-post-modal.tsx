...
import usePostsMutation, {
  CarouselAddItemData,
} from "../../hooks/usePostsMutation";
...
interface AddEditPostModalProps {
  isOpen: boolean;
  closeModal: () => void;
  onSubmit: (val: PostCard, isAddNew: boolean, isEdit: boolean) => void;
  editingItem?: PostCard | undefined;
  isEdit?: boolean;
}
...
export const AddEditPostModal: FC<AddEditPostModalProps> = (props) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // mutate(formData);
    onSubmit(formData, isOpen, Boolean(isEdit));
  };
